      ...
      <div className="customizable-text">
        ...
        <div className="customizable-content">
          ...
          <div className="text-content">
            ...
            <img src='./images/star.jpg' alt='Star' className='star1'></img>
          </div>
        </div>
      </div>
    </div>
